...
from fane.utils.segmentation_loss import MixedLoss
...
class SSLSegmenter(LightningModule):
    ...
    def shared_step(self, batch, batch_idx, split):
        ...
        return_dict = {"loss": loss, f"{split}_loss":loss.item(), f"{split}_dice": dice}
    ...
    def shared_epoch_end(self, step_outputs, split):
        ...
        dice = [x[f"{split}_dice"] for x in step_outputs]
