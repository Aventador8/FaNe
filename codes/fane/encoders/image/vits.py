...
if __name__ == "__main__":
    from transformers import ViTModel, ViTConfig, AutoModelForCausalLM

    config = ViTConfig.from_pretrained("google/vit-base-patch16-224-in21k")
    print(config)

    # config_decoder = ViTConfig(add_cross_attention=True)
    # model = AutoModelForCausalLM.from_config(config_decoder)
    # print(model)
    # import ipdb
    # ipdb.set_trace()
