...
class SentenceSplitter:
    def __init__(self, lang: str = 'de', download=False,
                 train_text: str = None, abbreviations: list = None,
                 section_splitter=None, optional_sections: list = None):
        if download:
            stanza.download(lang)
        self.stanza_tokenizer = stanza.Pipeline(lang, processors='tokenize', use_gpu=True)
...
def custom_mimic_cxr_rules():
    ...
    custom_indices = {
        # below have no findings and impression
